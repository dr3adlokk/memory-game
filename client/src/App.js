        	...
        	<Wrapper>
    			<div className="hero">
    				<div className="heroText">
    					<h1 className="banner">Soul Eater: Soul teaser:</h1>
        				<h3 className="rules">Head is to heart as soul is to mind. Yes, yes a blade must be sharp but more importantly; the mind. </h3>
        				<h3 className="message">{this.state.message}</h3>
    				</div>
    				<div className="buttonWrapper">
    					<img className="buttons" src="images/buttons.png" alt="Soul buttons" />
    				</div>
